...
orig = '/usr/share/applications/face.desktop'
dest = expanduser('~/.config/autostart')
desk = dest + '/face.desktop'


# Define application icon
def set_icon(entry_icon=None):
    icon = '/usr/share/pixmaps/face.svg'
    l_icon = '../appdata/face.svg'

    if entry_icon is not None:
        icon = '/usr/share/face/icon_status/' + entry_icon + '.png'
